...
[[https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/De_Alice%2527s_Abenteuer_im_Wunderland_Carroll_pic_23_edited_1_of_2.png/1920px-De_Alice%2527s_Abenteuer_im_Wunderland_Carroll_pic_23_edited_1_of_2.png][Cheshire Cat]][fn:3]
...
定义和使用起来其实不难，困惑的大多应该是后面的这堆理论-- 范畴论。当然，我也没学过范畴论，只是略微看得懂些 Haskell 罢了。

为了降低门槛, 我在书中也[[https://book.douban.com/subject/26883736/][写过一章]]用JavaScript来解释，某人也尝试过很[[http://www.ruanyifeng.com/blog/2017/02/fp-tutorial.html][写博客解释]]，没想到那些也不知道会不会 Haskell/Scala 的人就跑出来喷你们前端[fn:5]这些不懂函数式的渣渣乱搞出来的东西根本就不是 monad。

我也画过一些图来解释，又会被嫌弃画风不好。但是，作为灵魂画师，我只 +是觉得自己萌萌的啊+ 在乎画的灵魂是否能够给你一点启发。好吧，讲这么学术的东西，还是用dot来画吧，看起来好正规呢。

好了，安全带系好，我真的要开车了。为了防止{{{ruby(解释的不到位,又被喷)}}}，就用 Haskell/Scala 好了[fn:1]，其实也不难解释清楚 +才怪+ 。
...
另外 compose 在 haskell 中直接是 =.=, scala 中用 =<<<= 或者 =compose=
...
这样就会变成我们熟悉的 Funtor 的 Typeclass[fn:2]
...
Scala 没有 rank n type[fn:4], 只能靠 apply 来 meme 了
#+BEGIN_SRC scala
...
[fn:5] 等等, 写前端怎么了? JavaScript 只是我觉得顺手的若干语言之一, JS用户那么多, 写书当然要用 JS 啦, 难道用 Idris 那还能卖得掉吗?

[fn:4] 别急, 后面马上讲到

[fn:3] https://en.wikipedia.org/wiki/Cheshire_Cat

[fn:1] 并不是说这两门语言一定在鄙视链顶端, 而是拥有强大类型系统的语言才能体现出范畴论的内容

[fn:2] 这里可以把 Functor 的第一第二个参数消掉, 因为已经知道是在 Hask 范畴了
